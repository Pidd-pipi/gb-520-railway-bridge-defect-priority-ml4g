...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrDefectNotVerified), errors.Is(err, service.ErrInspectionOpen),
		errors.Is(err, service.ErrMissingBridge), errors.Is(err, service.ErrMissingInspection):
